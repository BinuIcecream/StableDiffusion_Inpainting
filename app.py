...
css = '''
    ...
    .form{border: none !important;box-shadow: none !important;border-radius: 10px 0px 0px 10px !important;}
    #button{max-width: 169px;max-height: 67px;border-radius: 0px 10px 10px 0px !important;}
